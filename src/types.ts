...
export interface AutocompleterCallbacks {
  ...
  onMessage?: (message: { message: string; suggester: string }) => void;
...
export interface Suggester {
  ...
  getSuggestions(
    text: string,
    callback: (results: Suggestion[], inputStr: string, suggesterName: string) => void,
    maxSuggestions: number,
  ): void;
